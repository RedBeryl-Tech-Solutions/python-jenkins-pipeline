...
public class PropertiesLoader {
    ...
    private static void loadAppDir() {
        try {
            ...
            //appPath = appPath.substring(0, appPath.lastIndexOf("/")); // ORIGINAL CODE BACKUP
            //appPath = appPath.substring(1, appPath.lastIndexOf("/"));
            appPath = "C:\\Users\\Acer\\Downloads\\sqlines-3.3.110-20231003T050304Z-001\\sqlines-3.3.110";
